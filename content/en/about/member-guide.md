...
To join the mailing list send e-mail to [tlug-request@tlug.jp](mailto:tlug-request@tlug.jp?subject=subscribe) and include ***subscribe*** in the subject line.
...
To subscribe to the TLUG digest, send mail to [tlug-digest-request@tlug.jp](mailto:tlug-digest-request@tlug.jp?subject=subscribe) and include ***subscribe*** in the subject line.
...
To subscribe to the TLUG-ADMIN mailing list send e-mail to [tlug-admin-request@tlug.jp](mailto:tlug-admin-request@tlug.jp?subject=subscribe) and include ***subscribe*** in the subject line.
...
The TLUG web site is accessible at <https://www.tlug.jp>
...
See the [meeting page](/meetings/) for details about upcoming meetings.
...
See the [meeting page](/meetings/) for details about upcoming parties.
...
TLUG is loosely structured. If you want to volunteer, don't be shy - we can use your help. A rough organization chart is available at [TLUG:Organization](/about/organization/)
...
- organize the parties (contact tlug-admin@tlug.jp)
